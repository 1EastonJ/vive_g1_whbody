...
This repository provides a whole-body teleoperation system that combines reinforcement learning (RL) for leg control with inverse kinematics (IK) for upper-body motion. Using Vive VR devices.
